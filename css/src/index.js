...
function ObtenerArrayFamiliares() {
  let testArray = document
    .querySelector("#arrayFamilia")
    .getElementsByClassName("familiar");
  return testArray;
}
...
function ocultarBoton(valor) {
  ...
  if (valor === true) {
    ...
    h2.innerHTML =
      "ahora, te pedimos que rellenes la edad de tus familiares ,son necesarios al menos 2 para poder continuar, te dejamos 2 botones mas por si te equivocaste en el numero de familiares, celda sin valor = 0 ";
  } else {
